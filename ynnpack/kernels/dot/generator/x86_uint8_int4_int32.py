...
"""
  ...
  def product(self, i, j, k):
    ...
    c_ijn = f"c_{i}_{j+n}"
    return f"""
{c_ij0} = {mm}_add_epi32({c_ij0}, {mm}_madd_epi16({mm}_maddubs_epi16({a_ik}, {b_kj0}), {mm}_set1_epi16(1)));
{c_ijn} = {mm}_add_epi32({c_ijn}, {mm}_madd_epi16({mm}_maddubs_epi16({a_ik}, {b_kjn}), {mm}_set1_epi16(1)));
"""
